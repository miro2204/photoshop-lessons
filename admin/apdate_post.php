        ...
        <table id="wrapper" >
	     ...
	     <tr id="menu_and_content">
                ...
                <?php 
                        ...
                        $result = mysql_query ("UPDATE data SET tittle='$title',meta_d='$meta_d',meta_k='$meta_k',date='$date',description='$description',text='$text',author='$author',mini_img='$img' ,cat='$cat'  WHERE id='$id'");
                        ...
                        {
                        echo "<p>Вы ввели не всю информацию, поэтому заметка в базу не может быть обновлена.</p>";
                        }
